...
def _reload_env_config():
    ...
    EnvConfig.AGENT_BLACKLIST_GROUP_LIST = fn.get("agent_whitelist_group_list", EnvConfig.AGENT_BLACKLIST_GROUP_LIST)
    EnvConfig.AGENT_BLACKLIST_PERSON_LIST = fn.get("agent_blacklist_person_list", EnvConfig.AGENT_BLACKLIST_PERSON_LIST)
    EnvConfig.AGENT_WITHELIST_GROUP_LIST = fn.get("agent_blacklist_group_list", EnvConfig.AGENT_WITHELIST_GROUP_LIST)
