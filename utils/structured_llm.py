...
async def structured_call(
    *, model: str, provider: str, schema: type[BaseModel], system_prompt: str,
    user_prompt: str, timeout: int, extra_body: dict | None = None,
    tag: str = "frontier:news",
):
    from utils.llm_factory import create_llm, structured_output_options

    kwargs = {
        "model": model, "provider": provider, "streaming": False, "max_retries": 0,
